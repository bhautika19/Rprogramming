...
logitmod <- glm(Class ~ 
                  Cl.thickness+Cell.shape #+ Cell.size
                + Marg.adhesion + 
                  Bare.nuclei+Bl.cromatin #+ Normal.nucleoli+ Epith.c.size #+ Mitoses
...
#evaluating accuracy of prediction model using confusion matrix on test data
