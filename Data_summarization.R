...
table(mtcars$cyl,mtcars$gear, mtcars$carb, dnn=c('Cyl','Gear','Carb'))  #3 dim
...
#here priority is from right to left
...
#here output is not in the form of list as it is included in the functionality and is used to combine the functions in list 
...
#sweep----
#externally operations can be done on a dataset using this syntax
