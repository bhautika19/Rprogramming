...
#Read the dataset
data <- read.csv("C:/Users/Dell/Documents/Rbasics/data/heart-disease.csv",header=TRUE)
...
#Also, "Gender" is incorrectly treated as a number, it can only be 1 if male and 0 if female.
