...
#Read the dataset----
data_adult<-read.csv("C:/Users/Dell/Documents/Rbasics/data/annual_income.csv")
...
#here we are dropping the other percentie and only displaying the 99th percentile
...
#here we can use ~.  instead of writing all the variables
...
#in other words we can say that 75% is <=50k and 25% is >50k
...
testData$Pred_Income <- ifelse(testData$Pred_Income > 0.386,1,0)
View(testData)
