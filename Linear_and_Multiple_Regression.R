#Regression
df <- read.csv("C:/Users/Dell/Documents/Rbasics/data/stud_reg.csv", header = T)
View(df)
df
...
#This is called backward propogation method:

lmMod<- lm(mpg~cyl+wt#+disp+hp#+drat+qsec#+vs+am#+gear+carb
